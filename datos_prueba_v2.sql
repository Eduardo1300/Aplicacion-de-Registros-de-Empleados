-- =============================================
-- SCRIPT SQL - DATOS DE PRUEBA COMPLETOS
...
-- =============================================
-- 3. INSERTAR EMPLEADOS (40 empleados)
-- =============================================
...
-- Empleado 4 - Ana Martínez (registro perfecto)
...
-- =============================================
-- 5. INSERTAR MÁS ASISTENCIAS PARA RESTO DE EMPLEADOS
-- =============================================
...
SELECT 
  ...
  'PRESENTE' as estado,
  CASE WHEN FLOOR(RAND() * 15) = 1 THEN 'Tardanza' WHEN FLOOR(RAND() * 30) = 1 THEN 'Ausencia' ELSE 'Entrada normal' END,
  NOW()
FROM empleados emp
CROSS JOIN (
...
-- =============================================
-- 6. INSERTAR TURNOS (si no existen)
-- =============================================
